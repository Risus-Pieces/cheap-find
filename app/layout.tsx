...
export const metadata: Metadata = {
  ...
  description: "Find the cheapest Chipotle, Taco Bell, Wendy's, Domino's, Marco's Pizza, Chili's, Whataburger, Popeyes, and Wingstop near you. Live per-location prices on an interactive map.",
};
